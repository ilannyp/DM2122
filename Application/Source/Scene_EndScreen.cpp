...
void Scene_EndScreen::Init()
{
	...
	meshList[GEO_GAMEOVER] = MeshBuilder::GenerateQuad("game_over", Color(1, 1, 1), 1.f);
...
void Scene_EndScreen::Render()
{
	...
	//No transform needed
	/*RenderTextOnScreen(meshList[GEO_TEXT], "Game Over", Color(0, 1, 0), 4, 25, 30);
	...
	/*
	if lose == true
	RenderTextOnScreen(meshList[GEO_TEXT], "You Lose", Color(0, 1, 0), 4, 25, 25);
	*/
